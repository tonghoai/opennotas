    ...
    <div class="modal-box w-5/6 lg:w-4/12 lg:max-w-3xl">
      ...
      <div class="pt-4 grid grid-cols-3 gap-4">
        <div class="col-span-1 text-left">
          <p class="mb-1 truncate overflow-hidden opacity-65">{{ $t('app.modal_notes_detail_last_sync') }}</p>
          <p class="mb-1 truncate overflow-hidden opacity-65">{{ $t('app.modal_notes_detail_last_modified') }}</p>
          <p class="mb-1 truncate overflow-hidden opacity-65">{{ $t('app.modal_notes_detail_created_at') }}</p>
          <p class="mb-1 truncate overflow-hidden opacity-65">{{ $t('app.modal_notes_detail_word_count') }}</p>
        ...
        <div class="col-span-2 text-right">
          ...
          <p class="mb-1 truncate overflow-hidden">{{ charactersCount }}</p>
        </div>
      </div>
    </div>
  </dialog>
